<template>
    ...
    <section
        ...
        style="
            background: url('assets/user/frontend/images/travel/bg.jpg') center
                center;
        "
    >
            ...
            <div class="row align-items-center">
                <div class="col-lg-7 col-md-6">
                    <div class="title-heading mt-4">
                        <h1
                            class="display-4 fw-bold text-white title-dark mb-3"
                        >
                            Vue Router <br />
                            Works
                        </h1>
                ...
                <div class="col-md-12 mt-4 pt-2">
                    <div class="tiny-six-item">
                        <div class="tiny-slide">
                            ...
                            >
                                <img
                                    src="assets/user/frontend/images/travel/dubai.jpg"
                                    class="img-fluid"
                                    alt=""
                                />
                        ...
                        <div class="tiny-slide">
                            ...
                            >
                                <img
                                    src="assets/user/frontend/images/travel/thailand.jpg"
                                    class="img-fluid"
                                    alt=""
                                />
                                <div class="overlay-work bg-dark"></div>
                        ...
                        <div class="tiny-slide">
                            ...
                            >
                                <img
                                    src="assets/user/frontend/images/travel/india.jpg"
                                    class="img-fluid"
                                    alt=""
                                />
                                <div class="overlay-work bg-dark"></div>
                        ...
                        <div class="tiny-slide">
                            ...
                            >
                                <img
                                    src="assets/user/frontend/images/travel/london.jpg"
                                    class="img-fluid"
                                    alt=""
                                />
                                <div class="overlay-work bg-dark"></div>
                        ...
                        <div class="tiny-slide">
                            ...
                            >
                                <img
                                    src="assets/user/frontend/images/travel/paris.jpg"
                                    class="img-fluid"
                                    alt=""
                                />
                                <div class="overlay-work bg-dark"></div>
                        ...
                        <div class="tiny-slide">
                            ...
                            >
                                <img
                                    src="assets/user/frontend/images/travel/singapore.jpg"
                                    class="img-fluid"
                                    alt=""
                                />
                                <div class="overlay-work bg-dark"></div>
    ...
    <section class="section bg-light">
            ...
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-6">
                    ...
                    >
                        <div class="position-relative">
                            <img
                                src="assets/user/frontend/images/travel/1.jpg"
                                class="card-img-top"
                                alt="..."
                            />
        ...
        <div class="container mt-100 mt-60">
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-6 order-1 order-md-2">
                    <img
                        src="assets/user/frontend/images/travel/3.jpg"
        ...
        <div class="container mt-100 mt-60">
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-6">
                    <img
                        src="assets/user/frontend/images/travel/2.jpg"
                        class="img-fluid rounded shadow-md"
                        alt=""
                    />
                </div>
                    ...
                    <div class="tiny-three-item">
                        <div class="tiny-slide">
                            <div class="d-flex client-testi m-2">
                                <img
                                    src="assets/user/frontend/images/client/01.jpg"
                                    class="
                                        avatar avatar-small
                                        client-image
                                        rounded
                        ...
                        <div class="tiny-slide">
                            <div class="d-flex client-testi m-2">
                                <img
                                    src="assets/user/frontend/images/client/02.jpg"
                                    class="
                                        avatar avatar-small
                                        client-image
                                        rounded
                        ...
                        <div class="tiny-slide">
                            <div class="d-flex client-testi m-2">
                                <img
                                    src="assets/user/frontend/images/client/03.jpg"
                                    class="
                                        avatar avatar-small
                                        client-image
                                        rounded
                        ...
                        <div class="tiny-slide">
                            <div class="d-flex client-testi m-2">
                                <img
                                    src="assets/user/frontend/images/client/04.jpg"
                                    class="
                                        avatar avatar-small
                                        client-image
                                        rounded
                        ...
                        <div class="tiny-slide">
                            <div class="d-flex client-testi m-2">
                                <img
                                    src="assets/user/frontend/images/client/05.jpg"
                                    class="
                                        avatar avatar-small
                                        client-image
                                        rounded
                        ...
                        <div class="tiny-slide">
                            <div class="d-flex client-testi m-2">
                                <img
                                    src="assets/user/frontend/images/client/06.jpg"
                                    class="
                                        avatar avatar-small
                                        client-image
                                        rounded
