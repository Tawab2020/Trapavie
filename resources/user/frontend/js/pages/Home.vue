<template>
  ...
  <section
    ...
    style="background: url('assets/user/frontend/images/travel/bg.jpg') center center"
  >
        ...
        <div class="col-12 text-center">
          <div class="section-title">
            <h4 class="title fw-bold mb-4">
              ...
              <br />Want to Break Free for a While
            </h4>
            <p class="text-muted para-desc mb-0 mx-auto">
              Start working with
              <span class="text-primary fw-bold">Landrick</span>
      ...
      <div class="row align-items-center">
        <div class="col-lg-5 col-md-6">
          <div class="card blog rounded border-0 shadow overflow-hidden">
            <div class="position-relative">
              <img src="assets/user/frontend/images/travel/1.jpg" class="card-img-top" alt="..." />
          ...
          <div class="section-title ms-lg-4">
            ...
            <ul class="list-unstyled text-muted">
              ...
              <li class="mb-1">
                <span class="text-primary h5 me-2">
                  <i class="uil uil-check-circle align-middle"></i>
                </span>Our Talented & Experienced Marketing Agency
              </li>
              <li class="mb-1">
                <span class="text-primary h5 me-2">
                  <i class="uil uil-check-circle align-middle"></i>
          ...
          <div class="accordion mt-4 pt-2" id="accordionExample">
            ...
            <div class="accordion-item rounded shadow mt-2">
              <h2 class="accordion-header" id="headingTwo">
                ...
                >Do I need a designer to use Landrick ?</button>
              </h2>
              <div
                id="collapseTwo"
            ...
            <div class="accordion-item rounded shadow mt-2">
              <h2 class="accordion-header" id="headingThree">
                ...
                >What do I need to do to start selling ?</button>
              </h2>
              <div
                id="collapseThree"
                class="accordion-collapse border-0 collapse"
            ...
            <div class="accordion-item rounded shadow mt-2">
              <h2 class="accordion-header" id="headingFour">
                ...
                >What happens when I receive an order ?</button>
              </h2>
              <div
                id="collapseFour"
                class="accordion-collapse border-0 collapse"
