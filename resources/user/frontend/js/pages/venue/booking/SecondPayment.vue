<template>
  <section class="section">
    <div class="container">
      <h3 class="text-gray-800 font-semibold">Second Payment for your booking</h3>
          ...
          <div class="col-12 col-md-6">
            ...
            <div class="row me-md-3 pe-md-3 me-lg-5 pe-lg-5 mt-3" v-if="booking.price">
              ...
              <div class="col-12">
                ...
                <h5
                  class="d-inline-block font-bold float-end"
                >{{currencySymbol}}{{booking.price.remaining_balance}}</h5>
                <span class="float-end me-2">({{100 - booking.cancellation_policy_log.deposit}}%)</span>
              </div>
            </div>
          </div>
...
export default {
  ...
  computed: {
    ...
    pricePerNight() {
      return this.booking.venue.guests_included
  ...
  methods: {
    ...
    async processPayment() {
      ...
      if (error) {
        ...
        this.user.amount = this.booking.price.remaining_balance * 100; // converting into cents
        ...
        axios
          ...
          .then((response) => {
            this.paymentProcessing = false;
            this.changeBookingStatusToFullyPaid();
    ...
    changeBookingStatusToFullyPaid() {
      axios
        .get(`venue/booking/${this.booking.id}/changeBookingStatusToFullyPaid`)
        .then((response) => {
        ...
        .catch((error) => {
          this.$toast.warning(
            "We recieved the payment, but another problem occured. Please contact us.",
            {
              position: "top-right",
            }
          );
