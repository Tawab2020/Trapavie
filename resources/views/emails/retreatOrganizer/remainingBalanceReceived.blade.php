...
<head>
    <meta charset="utf-8" />
    <title>Remaining Balance Received by Tripavie</title>
    ...
    <div style="margin-top: 50px;">
        <table cellpadding="0" cellspacing="0"
            ...
            <tbody>
                ...
                <tr>
                    <td style="padding: 0 24px 15px;">
                        <p>The remaining balance for booking {{ $booking['venue_log']['name'] }} has been received by
                            Tripavie.</p>
                        <p>Your booking is now fully paid.</p>
                    </td>
                </tr>
