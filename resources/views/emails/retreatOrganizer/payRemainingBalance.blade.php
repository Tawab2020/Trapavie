...
<head>
    <meta charset="utf-8" />
    <title>Pay Remaining Balance Reminder</title>
    ...
    <div style="margin-top: 50px;">
        <table cellpadding="0" cellspacing="0"
            ...
            <tbody>
                ...
                <tr>
                    <td style="padding: 0 24px 15px;">
                        <p> Pay the remaining balance required for your booking of
                            {{ $booking['venue_log']['name'] }}. This is the final payment you have to do for this
                            booking.</p>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding: 15px 24px;">
                        ...
                        <a href="http://127.0.0.1:8000/venues/{{ $booking['venue_id'] }}" class="font-medium"
                            style="padding: 8px 20px; outline: none; text-decoration: none; font-size: 16px; letter-spacing: 0.5px; transition: all 0.3s; border-radius: 6px; background-color: #2eca8b; border: 1px solid #07cc7d; color: #ffffff;">Pay
                            Remaining Balance</a>
                    </td>
                </tr>
