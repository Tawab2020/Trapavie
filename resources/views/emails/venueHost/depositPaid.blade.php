...
<head>
    <meta charset="utf-8" />
    <title>Deposit Paid to Tripavie</title>
    ...
    <div style="margin-top: 50px;">
        <table cellpadding="0" cellspacing="0"
            ...
            <tbody>
                ...
                <tr>
                    <td style="padding: 0 24px 15px;">
                        <p>The initial deposit for booking {{ $booking['venue_log']['name'] }} has been received by
                            Tripavie and the booking has been secured.</p>
                    </td>
                </tr>

                <tr>
                    <td style="padding: 15px 24px;">
                        <a href="http://127.0.0.1:8000/hosting/bookings" class="font-medium"
                            style="padding: 8px 20px; outline: none; text-decoration: none; font-size: 16px; letter-spacing: 0.5px; transition: all 0.3s; border-radius: 6px; background-color: #2eca8b; border: 1px solid #07cc7d; color: #ffffff;">Manage
                            bookings</a>
                    </td>
                </tr>
