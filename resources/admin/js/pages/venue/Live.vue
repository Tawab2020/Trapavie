  ...
  <div class="row">
    <div class="col-12">
      <div class="page-title-box">
        ...
        <h4 class="page-title">Live Venues</h4>
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-12">
      <div class="card">
        <div class="card-body">
          <h4 class="header-title">Live Venues</h4>
          ...
          <table class="table table-bordered table-centered mb-0">
            ...
            <tbody>
              <tr v-for="venue in venues.data" :key="venue.id">
                ...
                <td>
                  <i class="uil uil-circle text-success" style="font-size:0.7rem;"></i> Live
                </td>
      ...
      <div class="modal-content rounded shadow border-0">
        <div class="modal-body py-5">
          <div class="text-center">
            ...
            >
              <h1 class="mb-0">
                <i class="uil uil-keyhole-circle align-middle text-warning" style="font-size: 6rem"></i>
              </h1>
            </div>
            <div class="mt-4">
              <h4 style="text-transform: capitalize">UnApprove Venue?</h4>
              <p class="text-muted text-lowercase">
                <span class="text-capitalize">Are</span>
                you absolutely sure you want to unApprove this venue listing?
              </p>
              <div class="mt-4">
                <a
  ...
  methods: {
    getVenues(page = 1) {
      axios.get("venues?page=" + page, {
        ...
        this.liveVenues = response.data;
      });
    },
    unApproveVenue() {
      axios.post(`venue/${this.toBeUnApproved}/unApprove`).then(({ data }) => {
        let index = this.liveVenues.data.findIndex(
          (venue) => venue.id == this.toBeUnApproved
        );
        this.liveVenues.data.splice(index, 1);
