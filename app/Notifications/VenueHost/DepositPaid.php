...
class DepositPaid extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->subject('Initial Deposit Paid')
            ->view(
                'emails.venueHost.depositPaid',
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            "message" => "The initial deposit for $venue_name has been recieved by Tripavie. The booking is now secured.",
