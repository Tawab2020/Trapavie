...
class DepositReminder extends Notification implements ShouldQueue
{
    use Queueable;
    protected $booking;
    protected $venue;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->subject('Initial Deposit Reminder')
            ->view(
                'emails.retreatOrganizer.depositReminder',
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            "message" => "Secure booking $venue_name by paying the initial deposit.",
