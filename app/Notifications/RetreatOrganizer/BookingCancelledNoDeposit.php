...
class BookingCancelledNoDeposit extends Notification implements ShouldQueue
{
    use Queueable;
    protected $booking;
    protected $venue;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->view(
                'emails.retreatOrganizer.bookingCancelledNoDeposit',
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            "message" => "Your booking for $venue_name was cancelled, because we did not recieve the initial deposit.",
