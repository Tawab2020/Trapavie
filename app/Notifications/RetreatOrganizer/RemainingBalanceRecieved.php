...
class RemainingBalanceRecieved extends Notification implements ShouldQueue
{
    use Queueable;
    protected $booking;
    protected $venue;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->view(
                'emails.retreatOrganizer.remainingBalanceReceived',
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            "message" => "The remaining balance for the booking for $venue_name has been recieved by Tripavie.",
