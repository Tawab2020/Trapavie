        ...
        (t.prototype.initMenu = function () {
            ...
            (t.prototype.initSearch = function () {
                ...
                a(document).on("click", function (t) {
                    return (
                        "top-search" == t.target.id ||
                        t.target.closest("#search-dropdown")
        ...
        (t.prototype._selectOptionsFromConfig = function () {
            ...
            if (t) {
                ...
                t.isBoxed
                    ...
                    t.isScrollable &&
                        a("#scrollable-check").prop("checked", !0),
                    t.isScrollable ||
                        t.isCondensed ||
                    ...
                    t.isDarkModeEnabled ||
                        ...
                        "vertical" === t.layout &&
                            a("input[type=checkbox][name=theme]").prop(
                                "disabled",
                                !1
                            )),
                    t.isDarkModeEnabled &&
            ...
            (t.prototype.init = function () {
                ...
                a(document).on("click", ".end-bar-toggle", function () {
                    ...
                    a(document).on("click", "body", function (t) {
                        0 <
                            a(t.target).closest(".end-bar-toggle, .end-bar")
                                .length ||
                            0 <
                                a(t.target).closest(".leftside-menu, .side-nav")
                                    .length ||
                            a(t.target).hasClass("button-menu-mobile") ||
                            0 <
                                a(t.target).closest(".button-menu-mobile")
                                    .length ||
                    ...
                    a("input[type=checkbox][name=color-scheme-mode]").change(
                        function () {
                            switch (a(this).val()) {
                                case "light":
        ...
        (t.prototype._saveConfig = function (t) {
            ...
            (t.prototype.reset = function (t) {
                ...
                a("#main-style-container").length &&
                    (e.defaultSelectedStyle = a("#main-style-container").attr(
                        "href"
                    )),
                    e.deactivateCondensedSidebar(),
